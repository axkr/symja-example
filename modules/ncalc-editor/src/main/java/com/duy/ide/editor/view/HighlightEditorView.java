...
import com.jecelyin.editor.v2.SysUtils;
...
public abstract class HighlightEditorView extends AppCompatMultiAutoCompleteTextView
    ...
    public void setTheme(@NonNull EditorTheme editorTheme) {
        ...
        int fgColor = editorTheme.getFgColor();
        setHintTextColor(Color.argb(100, Color.red(fgColor), Color.green(fgColor), Color.blue(fgColor)));

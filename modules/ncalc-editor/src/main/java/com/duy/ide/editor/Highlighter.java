...
public class Highlighter {
     ...
     */
    public void highlightError(TextBuffer buffer, EditorTheme editorTheme,
    ...
    public void highlightWarn(TextBuffer buffer, EditorTheme editorTheme,
                              HashMap<Integer, ArrayList<? extends CharacterStyle>> colorsMap,
                              Spannable spannable,
                              int startLine, int endLine, boolean includeWhitespace) {
    ...
    public void highlight(TextBuffer buffer, EditorTheme editorTheme,
                          HashMap<Integer, ArrayList<? extends CharacterStyle>> colorsMap,
                          Spannable spannable,
    ...
    private void collectToken(SyntaxStyle[] syntaxStyles, TextBuffer buffer, int lineNumber, Token token,
                              ArrayList<HighlightInfo> mergerArray) {
